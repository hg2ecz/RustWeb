...
Az RWLang a webes biztonsági metaadatokat a statikus típusellenőrzés részének tekinti, nem opcionális framework-ajánlásnak.
...
Az RWLang szándékosan nem kényszeríti a fejlesztőt wrapper-zajos `Authorized<Profile, Read>` típusok kiírására a hétköznapi handler kódban. Az `authorize` ugyanazt a változót finomítja. Így a forrás egyszerű marad, miközben a compiler statikus környezetében megvan a bizonyíték.
