...
Az RWLang tenant izolációja a platform által kezelt, hitelesített membership claimre épül. A tenant scope nem egyszerű String-összehasonlítás, és nem az első membershipből következtetjük ki.
