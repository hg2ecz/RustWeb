...
Az RWLang a navigációt és a külső hálózati hozzáférést capabilityként kezeli, nem tetszőleges stringként.
...
Az RWLang forrásban továbbra sincs korlátlan `http.get(String)` primitív. A külső hálózat trusted integration boundary marad. A Rust integration API capability-flow-t használ:
...
A későbbi RWLang-szintű integration szintaxisnak ugyanezekre a capabilitykre kell fordulnia, nem általános URL-fetch primitívre.
