...
Az RWLang minden kérésre automatikusan alkalmazza a platform request budgetjét. Az alkalmazáskódnak nem kell külön bekapcsolnia az instruction- és allocation-limitet.
