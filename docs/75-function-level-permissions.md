...
RWLang permissions are named application capabilities backed by the roles already carried by the platform-owned authenticated session. They let application code express business intent once instead of copying role lists across routes and handlers.
