...
RWLang applies the platform request budget to every request automatically. Application code does not need to opt in to instruction and allocation limits.
