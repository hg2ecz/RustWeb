...
The minimal wiki is also checked as a compilation fixture in \code{examples/wiki/main.rw}; the CMS is the multi-file \code{examples/news-site/} project. These examples are therefore not merely book pseudocode. When a listing is shortened here, prefer the repository fixture as the copy/paste source of truth.
