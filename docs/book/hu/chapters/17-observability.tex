...
A security monitoring strukturált platform boundary, nem ad-hoc log message convention. Automatikus event keletkezik auth abuse, MFA failure, policy/CSRF/origin/CORS denial, webhook verification failure, idempotency conflict és resource exhaustion esetén.
