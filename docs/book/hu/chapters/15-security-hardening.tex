...
Az RWLang security nem opcionális middleware-ek gyűjteménye. A nyelv, compiler, runtime és server úgy osztja fel az authorityt, hogy a biztonságos út legyen a normál út. Az alapelv: amit statikusan lehet bizonyítani, legyen compiler invariant; amit nem, ott legyen secure platform default; ha egyik sem lehetséges, a rendszer stabil security diagnostic mellett fail closed.

Ez összefoglaló fejezet, nem második API-tutorial. A korábbi fejezetek ott mutatják be az egyes mechanizmusokat, ahol ténylegesen használjuk őket; itt az a cél, hogy production üzemeltetés előtt egyben review-zható legyen az összhatásuk.

\section{Mit dönt el a secure modell -- és mit nem?}

Az RWLang reprezentálhatatlanná tehet raw SQL-t, arbitrary redirect URL-t, ambient DB/network authorityt, unbounded list queryt, hamis redactiont és több más veszélyes állapotot. Azt is bizonyíthatja, hogy egy mutation authorization proofot használt. Azt viszont nem döntheti el helyetted, hogy az üzleti szabály szerint ``az Editor publikálhatja-e ezt a konkrét cikket''. Ez továbbra is az alkalmazás permission/object/tenant policyjének feladata.
...
Az RWLang egyedi műveletet és teljes requestet is korlátoz:
...
Ha bármelyik válasz homályos, a feature security modellje még nincs kész.
