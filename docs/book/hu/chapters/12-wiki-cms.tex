...
A wiki minimális, fordítási fixture-ként is ellenőrzött változata az \code{examples/wiki/main.rw}; a CMS többfájlos mintája az \code{examples/news-site/}. Így az alábbi két alkalmazásminta nem csak könyvbeli pszeudokód. Ha a könyv egy listinget rövidít, copy/paste kiindulópontnak a repository fixture legyen a source of truth.
