...
Az RWLang zárt sum type-jai security-releváns exceptional state-et compile-time tesztelhetővé tesznek. A \code{match} nem ad catch-all wildcardot, ezért új variant hozzáadása minden érintett match site review-ját kikényszeríti.
