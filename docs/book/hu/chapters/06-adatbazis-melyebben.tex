...
A \code{List<Model>} querynek az SQL-ben statikus literal sorlimitje is kell legyen. A bound a reusable query contract része, nem a hívó által adott \code{limit} paraméter; használj fix \code{LIMIT}-et, és bounded offsettel vagy más explicit hozzáférési mintával paginálj.
