...
A limiter szándékosan többdimenziós, nem egyetlen username+IP counter. A platform egyszerre követi a source+principal, principal több source-on keresztül és source több principalon keresztül dimenziót; MFA/recovery külön szigorúbb stage. Így distributed guessing egy account ellen és credential stuffing egy source-ból is korlátozott. Sikeres login csak a konkrét párt törli, a source-wide/principal-wide abuse historyt nem. Shared limiter-store hiba fail closed.
